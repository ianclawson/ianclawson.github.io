...
struct MeView: Component {
    var body: Component {
        Div {
            Div {
                Div {
                    H2("Hi, I'm Ian").class("text-3xl font-extrabold tracking-tight sm:text-4xl")
                    H2("I like mobile apps that look cool and help people.").class("text-xl text-gray-500")
                }.class("space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl")
                List {
                    ListItem {
                        Div {
                            Image(url: "https://avatars0.githubusercontent.com/u/18663382?v=4", description: "Profile image").class("mx-auto h-40 w-40 rounded-full xl:w-56 xl:h-56")
                        }
                        .class("space-y-6")
                    }
                }
                .class("mx-auto space-y-16 sm:grid sm:grid-cols-1 sm:gap-16 sm:space-y-0 lg:grid-cols-1 lg:max-w-5xl")
                .listStyle(.unordered)
            }.class("space-y-12")
